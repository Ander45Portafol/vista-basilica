<template>
    <NuxtLink to="/perfil">
        <img v-if="imagen != null" :src="api_url + imagen" alt="" class="w-10 h-10 rounded-full">
        <svg v-else width="24px" height="24px" stroke-width="2.5" viewBox="0 0 24 24" fill="none"
