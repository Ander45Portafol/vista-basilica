...
<template>
  <div
    ...
    v-for="anuncio in datos_anuncios[paginacion - 1]"
    :key="anuncio.id"
  >
    <div
    ...
    >
      <div class="flex justify-start w-3/4 items-center max-[400px]:w-full">
        <img
          :src="api_url + anuncio.campos.imagen_anuncio"
      ...
      >
        <button
          ...
          @click.prevent="estadoActualizar(anuncio.id)"
        ...
        <button
          @click.prevent="borrarAnuncio(anuncio.id, anuncio.campos.anuncio)"
          v-if="anuncio.campos.visibilidad_anuncio == 1"
        ...
        <button
          v-else
          @click="recuperarUnAnuncio(anuncio.id, anuncio.campos.anuncio)"
            ...
            <div class="flex-col w-64">
              ...
              <div class="relative z-0">
                ...
                <input
                  ...
                  id="title_anuncio"
                  name="titulo_anuncio"
                  v-model="form.titulo_anuncio"
                  @input="validarTituloAnuncio()"
                  maxlength="100"
                  required
                ...
                <label
                  ...
                  >Título - Anuncio<span class="text-sm ml-1"> * </span></label
                >
              </div>
              <div
                v-if="!validarTituloAnuncio()"
              ...
              >
                ...
                <div>
                  El título del anuncio solo permite caracteres
              ...
              <div class="relative z-0 mt-6">
                ...
                >
                <label
                  for="contenido_anuncio"
                  class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                  >Contenido - Anuncio</label
                >
              </div>
              <div class="relative z-0 mt-10">
                ...
                <label
                  for="username"
                  class="absolute text-lg text-gray-200 duration-300 transform -translate-y-8 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                  >Fecha - Anuncio<span class="text-sm ml-1"> * </span></label
                >
              </div>
              <div class="relative z-0 mt-6">
                <!-- Campo de entrada de texto -->
...
var api_url = "http://localhost:8000/storage/anuncios/images/";
...
async function crearAnuncio() {
  if (validarTituloAnuncio()) {
    ...
    try {
      ...
      formData.append("visibilidad_anuncio", form.value.visibilidad_anuncio ? 1 : 0);
      formData.append("imagen_anuncio", form.value.imagen_anuncio);
      //Se realiza la petición axios mandando la ruta y el formData
      await axios
        .post("/anuncios/", formData, {
          headers: {
  ...
  try {
    ...
    await axios
      ...
      .then((res) => {
        ...
        if (res.data.data.campos.imagen_anuncio != null) {
...
async function actualizarAnuncio() {
  if (validarTituloAnuncio()) {
    ...
    try {
      ...
      //Se realiza la petición axios mandando la ruta y el formData
      await axios
        .post("/anuncios_update/" + id, formData, {
          headers: {
