<template>
  <div
    ...
    v-for="rolusuario in datos_rol_usuario[paginacion - 1]"
    :key="rolusuario.id"
  >
    <div
    ...
    >
      <div class="flex justify-start w-3/4 items-center max-[400px]:w-full">
        ...
        >
          ...
          <p class="font-extrabold text-xl text-salte-900 max-[750px]:text-[18px]">
            {{ rolusuario.campos.rol_usuario }}
          </p>
          <p
            v-if="rolusuario.campos.visibilidad_rol_usuario"
      ...
      >
        <button
          class="h-10 w-10 rounded-md flex items-center justify-center reportbtn"
        ...
        <button
          ...
          @click="borrarRolUsuario(rolusuario.id)"
          v-if="rolusuario.campos.visibilidad_rol_usuario == 1"
        >
          <svg
            width="26px"
        ...
        <button
          @click="recuperarUnRolUsuario(rolusuario.id)"
      ...
      <div class="relative rounded-lg shadow modal">
        ...
        <div class="flex items-start justify-between p-4 rounded-t">
          <div class="flex-col ml-4 pt-4">
            ...
            <p class="text-base font-medium text-gray-400">Rol - Usuario</p>
          </div>
          <button
            type="button"
            id="closeModal"
          ...
          <form id="formModal" @submit.prevent="submitForm()">
            <div class="flex justify-center w-full">
              ...
              <div class="relative z-0">
                ...
                <span class="text-xs text-gray-400 absolute bottom-0.5 right-0">
                  {{ form.rol_usuario.length }} /50</span
                >
                <label
                  for="rol_usuario"
            ...
            <div class="flex m-10 justify-evenly">
              <div class="flex-col mt-6">
                ...
                <div class="flex text-white mt-4">
                  <input
                    id="acceso_usuarios"
                    type="checkbox"
                    v-model="form.acceso_usuarios"
                    class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                  />
                  <label for="acceso_usuarios" class="ml-2 text-sm font-medium text-white"
                    >Usuarios</label
                  >
                </div>
                <div class="flex text-white mt-4">
                  <input
                    id="acceso_navegabilidad"
                    type="checkbox"
                    v-model="form.acceso_navegabilidad"
                    class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                  />
                  <label
                    for="acceso_navegabiildad"
                    class="ml-2 text-sm font-medium text-white"
                    >Navegabilidad</label
                  >
                </div>
                <div class="flex text-white mt-4">
                  <input
                    id="acceso_anuncios"
                    type="checkbox"
                    v-model="form.acceso_anuncios"
                    class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                  />
                  <label for="acceso_anuncios" class="ml-2 text-sm font-medium text-white"
                    >Anunios</label
                  >
                </div>
                <div class="flex text-white mt-4">
                  <input
                    id="acceso_mensajes"
                    type="checkbox"
                    v-model="form.acceso_mensajes"
                    class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                  />
                  <label for="acceso_mensajes" class="ml-2 text-sm font-medium text-white"
                    >Mensajes</label
                  >
                </div>
              </div>
              <div class="flex-col mt-6">
                <div class="flex text-white">
                  <input
                    id="acceso_donaciones"
                    type="checkbox"
                    v-model="form.acceso_donaciones"
                    class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                  />
                  <label
                    for="acceso_donaciones"
                    class="ml-2 text-sm font-medium text-white"
                    >Donacionees</label
                  >
                </div>
                <div class="flex text-white mt-4">
                  <input
                    id="acceso_donantes"
                    type="checkbox"
                    v-model="form.acceso_donantes"
                    class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                  />
                  <label for="acceso_donantes" class="ml-2 text-sm font-medium text-white"
                    >Donantes</label
                  >
                </div>
                <div class="flex text-white mt-4">
                  <input
                    id="acceso_calendario"
                    type="checkbox"
                    v-model="form.acceso_calendario"
                    class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                  />
                  <label
                    for="acceso_calendario"
                    class="ml-2 text-sm font-medium text-white"
                    >Calendario</label
                  >
                </div>
                <div class="flex text-white mt-4">
                  <input
                    id="acceso_personal"
                    type="checkbox"
                    v-model="form.acceso_personal"
                    class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                  />
                  <label for="acceso_personal" class="ml-2 text-sm font-medium text-white"
                    >Personal</label
                  >
                </div>
...
async function crearRolUsuario() {
  ...
  if (validarRolUsuario()) {
    try {
      ...
      FORM_DATA.append(
        "visibilidad_rol_usuario",
        form.value.visibilidad_rol_usuario ? 1 : 0
      );
      //Se realiza la petición axios mandando la ruta y el formData
      await axios
        .post("/roles_usuarios/", FORM_DATA, {
          headers: {
    ...
    await axios
      ...
      .then((res) => {
        ...
        form.value = {
          ...
          visibilidad_rol_usuario: res.data.data.campos.visibilidad_rol_usuario
            ? true
            : false,
        };
        //Se reinicia el timer
...
async function actualizarRolUsuario() {
  ...
  if (validarRolUsuario()) {
    try {
      ...
      //Se realiza la petición axios mandando la ruta y el formData
      await axios
        .post("/roles_usuarios_update/" + id, FORM_DATA, {
          headers: {
            Authorization: `Bearer ${token.value}`,
          },
        })
