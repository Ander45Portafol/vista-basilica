        ...
        <div
            ...
            <div
                ...
                <button class="h-10 w-10 rounded-md flex items-center justify-center reportbtn"
                    @click="generarReporteRol(rolusuario.id)" v-if="rolusuario.campos.visibilidad_rol_usuario == 1">
                    ...
                    <form id="formModal" @submit.prevent="submitForm()">
                        ...
                        <div class="flex m-10 justify-evenly">
                            <div class="flex-col mt-6">
                                <div class="flex text-white">
                                    <input id="acceso_parroquia" type="checkbox" v-model="form.acceso_parroquia"
                                ...
                                <div class="flex text-white mt-4">
                                    <input id="acceso_navegabilidad" type="checkbox" v-model="form.acceso_navegabilidad"
                                        class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                            ...
                            <div class="flex-col mt-6">
                                <div class="flex text-white">
                                    <input id="acceso_donaciones" type="checkbox" v-model="form.acceso_donaciones"
                                        class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                ...
                                <div class="flex text-white mt-4">
                                    <input id="acceso_calendario" type="checkbox" v-model="form.acceso_calendario"
                                        class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                        ...
                        <div class="flex w-full">
                            ...
                            <div class="modal-buttons mt-6 flex justify-end items-end">
                                ...
                                <button id="btnModalUpdate" type="submit" :disabled="!validarRolUsuario()"
                                    class="h-10 ml-2 w-10 rounded-lg flex justify-center items-center">
                                    <svg width="22px" height="22px" stroke-width="2" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" color="#000000">
                                        <path
