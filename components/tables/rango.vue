        ...
        <div
            ...
            <div class="flex justify-start w-3/4 items-center max-[400px]:w-full">
                <img :src="api_url + rango.campos.imagen_rango"
                    @click="mostrarLightBox(api_url + rango.campos.imagen_rango)"
                        ...
                        <div class="flex-col w-64">
                            ...
                            <div class="relative z-0">
                                <input type="text" id="nombre_rango" name="nombre_rango" v-model="form.nombre_rango"
                                    maxlength="100" required @input="validarNombreRango()"
...
async function actualizarRango() {
    ...
    if (validarNombreRango() && validarDescripcionRango()) {
        try {
            ...
            await axios
                .post("/rangos_update/" + id, FORMDATA, {
                    headers: {
                        "Content-Type": "multipart/form-data",
                        Authorization: `Bearer ${token.value}`,
                    },
...
//Variables para el funcionamiento del lightbox
