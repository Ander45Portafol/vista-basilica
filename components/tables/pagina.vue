<template>
    ...
    <div class="contained-data flex-col" v-for="pagina in datos_paginas[paginacion - 1]" :key="pagina.id">
        <div
            ...
            <div class="flex justify-start w-3/4 items-center max-[400px]:w-full">
                <div
                    ...
                    <p v-if="pagina.campos.descripcion_pagina &&
            ...
            <div
                ...
                <button class="h-10 w-10 rounded-md flex items-center justify-center max-[400px]:mx-4 editbtn" id="btnedit"
                    v-if="pagina.campos.visibilidad_pagina == 1" @click.prevent="estadoActualizar(pagina.id)">
