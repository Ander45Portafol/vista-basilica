<template>
  <div
    ...
    v-for="donante in datos_donantes[paginacion - 1]"
    :key="donante.id"
  >
    <div
    ...
    >
      <div class="flex justify-start w-3/4 items-center max-[400px]:w-full">
        ...
        >
          <p class="font-extrabold text-xl text-salte-900 max-[750px]:text-[18px]">
            {{ donante.campos.nombre_donante }} {{ donante.campos.apellido_donante }}
          </p>
          <p class="font-normal text-sm mt-1text-gray-500 max-[750px]:text-[12px]">
            {{ donante.campos.correo_donante }}
          </p>
      ...
      >
        <button
          id="graphbtn"
          @click="abrirModalGrafica(donante.id)"
        ...
        <div class="flex items-start justify-between p-4 rounded-t">
          <div class="flex-col ml-4 pt-4">
            ...
            <p class="text-lg font-medium text-gray-400">
              Donaciones según su donante (Últimas 6 donaciones realizadas)
            </p>
          </div>
          <button
            type="button"
        ...
        <div class="p-8 space-y-6">
          <div class="flex-col">
            <div class="h-80 contenedor_graficas w-full flex items-center justify-center">
              <Bar
                v-if="
                  dataGrafica && dataGrafica.data.results.length > 0 && dataListaGrafica
                "
                :data="chartDonante"
              ...
              >
                ...
                <div class="ml-3 text-sm font-medium">
                  <p class="font-bold">
                    Información:
                    <span class="font-normal">No existen datos para mostrar.</span>
                  </p>
                </div>
              </div>
            </div>
            <div class="flex justify-between mt-6">
              <div class="relative z-0 w-64" id="nombre_donante">
                <input
                  v-model="formGrafica.nombre_completo_donante"
                  type="text"
                  id="nombre_donante"
                  name="nombre_donante"
                  readonly
...
console.log(props.datos_donantes);
  ...
  try {
    ...
    await axios
      ...
      .then((res) => {
        ...
        opcionesChart.plugins.title.text =
          "Total donado a lo largo del tiempo: $" + formGrafica.value.suma_donaciones;
    ...
    if (result.isConfirmed) {
      try {
        ...
        try {
          ...
          TOAST.fire({
            icon: "success",
            title: "Donante recuperado exitosamente",
          });
        } catch (error) {
          console.log(error);
        }
