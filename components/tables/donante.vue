<template>
    <div class="contained-data flex-col" v-for="donante in datos_donantes[paginacion - 1]" :key="donante.id">
        <div
            ...
            <div
                ...
                <button
                    ...
                    @click="borrarDonante(donante.id)" v-if="donante.campos.visibilidad_donante == 1">
