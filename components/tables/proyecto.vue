        ...
        <div
            ...
            <div class="buttons-data flex justify-center items-center max-[750px]:flex-col max-[400px]:flex-row max-[400px]:m-auto max-[400px]:mt-2"
                ...
                <button
                    ...
                    @click="
                        recuperarProyecto(proyecto.id, proyecto.campos.nombre_proyecto)
                        ">
                        ...
                        <div class="flex justify-evenly w-full flex-wrap">
                            ...
                            <div class="flex-col w-64">
                                ...
                                <div class="pt-4 mt-2 flex-col">
                                    ...
                                    <select id="underline_select" v-model="form.estado_proyecto"
                                        ...
                                        <option value="En curso" class="bg-gray-700">
                                            En curso
                                        </option>
                                        <option value="Finalizado" class="bg-gray-700">
                                            Finalizado
                                        </option>
                            ...
                            <div class="h-42 ml-32 mt-6 progressbar rounded-xl text-center min-w-[75%]">
                                ...
                                <div class="flex items-center justify-center text-white">
                                    ...
                                    <p class="ml-4">
                                        ${{ formPorcentaje.meta_monetaria_porcentaje }}
                                    </p>
                                </div>
                            ...
                            <div class="flex flex-wrap w-64 mt-12 mb-24">
                                <div class="flex ml-[-100px]">
                                    <div class="flex-row">
                                        <p class="mb-4 ml-12 text-center text-gray-200">
                                            Icono - Proyecto
                                        </p>
                          ...
                          ">
                                    ...
                                    <div class="flex-col">
                                        ...
                                        <div class="ml-16 h-32 w-32 border-2 border-slate-900 rounded-lg cursor-pointer relative"
                                            ...
                                            <div v-if="mostrarIconoBorrarImagenPrincipal &&
                          ...
                          ">
                                ...
                                <div class="modal-buttons flex justify-end items-end absolute bottom-6 right-6">
                                    ...
                                    <button id="btnModalUpdate" type="submit" :disabled="!validarNombreProyecto() || form.estado_proyecto == 0
...
async function generarReporteProyecto(id_proyecto) {
    ...
    const ruta = new URL(
        `http://127.0.0.1:8000/api/proyecto_reporte/` + id_proyecto
    );
    ...
    if (validarNombreProyecto() && form.value.estado_proyecto != 0) {
        try {
            ...
            FORMDATA.append(
                ...
                form.value.visibilidad_proyecto ? 1 : 0
            );
        ...
        await axios
            ...
            .then((res) => {
                ...
                form.value = {
                    ...
                    visibilidad_proyecto: res.data.data.campos.visibilidad_proyecto
                        ? true
                        : false,
                };
                ...
                if (res.data.data.campos.imagen_principal != null) {
                    ...
                    imagenPrincipalPreview.value =
                        imagenes_url + form.value.imagen_principal;
                } else {
