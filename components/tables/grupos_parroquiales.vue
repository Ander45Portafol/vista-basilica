  ...
  <div class="flex-col contained-data" v-for="grupo in datos_grupos[paginacion - 1]" :key="grupo.id">
    <div
      ...
      <div
        ...
        <button v-if="grupo.campos.visibilidad_grupo == 1"
          ...
          <svg width="26px" height="26px" stroke-width="2" viewBox="0 0 24 24" fill="none"
            ...
            <path d="M18 4H4.6a.6.6 0 00-.6.6V18M7 16.8l5.444-1.8L21 18M16.5 13a1.5 1.5 0 110-3 1.5 1.5 0 010 3z"
              stroke="#3F4280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
          </svg>
        </button>
        ...
        <div class="p-6 space-y-6 pb-14">
          <form action="" id="formModal" @submit.prevent="submitForm()" class="flex justify-evenly">
            <div class="flex-col w-64">
              ...
              <div v-if="!validarNombreGrupo()" class="flex mt-2 mb-0 text-sm text-red-400 bg-transparent" role="alert">
              ...
              <div class="relative z-0 mt-6">
                <input type="text" id="nombre_encargado" name="nombre_encargado" maxlength="100"
                  ...
                  class="block py-2.5 px-0 w-full text-sm text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 peer focus:border-moradoClaroLogin peer"
                  placeholder=" " autocomplete="off" />
                <span class="text-xs text-gray-400 absolute bottom-0.5 right-0" v-if="form.nombre_encargado">
              ...
              <div class="relative z-0 mt-6">
                <input type="email" id="correo_encargado" name="correo_encargado" required maxlength="100"
                  ...
                  class="block py-2.5 px-0 w-full text-sm text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 peer focus:border-moradoClaroLogin peer"
                  placeholder=" " autocomplete="off" />
                <span class="text-xs text-gray-400 absolute bottom-0.5 right-0" v-if="form.correo_encargado">
                ...
                <label for="username"
                  ...
                  - Encargado<span class="ml-1 text-sm"> * </span></label>
              </div>
              <div class="flex-col pt-4 mt-4">
                <label for="" class="absolute text-sm text-gray-200">Categoría - Grupo<span class="ml-1 text-sm"> *
                  </span></label>
            ...
            <div class="flex-col w-64">
              <div class="relative z-0">
                <textarea id="descripcion_grupo" name="descripcion_grupo" required maxlength="1000"
                  ...
                  placeholder=" " autocomplete="off" />
                <span class="text-xs text-gray-400 absolute bottom-0.5 right-5" v-if="form.descripcion_grupo">
              ...
              <div class="relative z-0 mt-6">
                <input type="text" id="apellido_encargado" name="apellido_encargado" maxlength="100"
                  ...
                  class="block py-2.5 px-0 w-full text-sm text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 peer focus:border-moradoClaroLogin peer"
                  placeholder=" " autocomplete="off" />
                <span class="text-xs text-gray-400 absolute bottom-0.5 right-0" v-if="form.apellido_encargado">
              ...
              <div v-if="!validarApellidoEncargado()" class="flex mt-2 mb-0 text-sm text-red-400 bg-transparent"
                role="alert">
                <svg aria-hidden="true" class="flex-shrink-0 inline w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd"
              ...
              <div class="relative z-0 mt-6">
                <input type="text" id="telefono_encargado" name="telefono_encargado" maxlength="9"
                  @input="validarTelefono()" v-model="form.telefono_encargado"
                  class="block py-2.5 px-0 w-full text-sm text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 peer focus:border-moradoClaroLogin peer"
                  placeholder=" " autocomplete="off" />
                <span class="text-xs text-gray-400 absolute bottom-0.5 right-0" v-if="form.telefono_encargado">
              ...
              <div v-if="!validarTelefono()" class="flex mt-2 mb-0 text-sm text-red-400 bg-transparent" role="alert">
                <svg aria-hidden="true" class="flex-shrink-0 inline w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd"
                    d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"
              ...
              <div class="flex-col mt-6">
                ...
                <div class="flex justify-start mt-2">
                  <label class="relative inline-flex items-center mb-5 cursor-pointer">
                    <input type="checkbox" value="" class="sr-only peer" id="visibilidad_grupo" name="visibilidad_grupo"
              ...
              <div class="">
                ...
                <div class="flex-col m-auto">
                  ...
                  <div class="m-auto max-[630px]:text-center max-[630px]:ml-[-58px]">
                    <button type="button" class="w-40 py-2 mt-3 text-center bg-white rounded-md ml-14 hover:bg-slate-300"
        ...
        <div class="flex-col p-8 space-y-6">
          <div class="flex items-center justify-between">
            ...
            <button class="flex items-center justify-center h-10 rounded-lg bg-purpleLogin hover:bg-lightPurpleLogin w-14"
              ...
              <svg width="26px" height="26px" stroke-width="2" viewBox="0 0 24 24" fill="none"
                xmlns="http://www.w3.org/2000/svg" color="#000000">
                <path d="M13 21H3.6a.6.6 0 01-.6-.6V3.6a.6.6 0 01.6-.6h16.8a.6.6 0 01.6.6V13" stroke="#FFFFFF"
                  stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M3 16l7-3 5.5 2.5M16 10a2 2 0 110-4 2 2 0 010 4zM16 19h3m3 0h-3m0 0v-3m0 3v3" stroke="#FFFFFF"
                  stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              </svg>
            </button>
          </div>
