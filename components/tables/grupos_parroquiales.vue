<template>
  ...
  <div
    class="flex-col contained-data"
    v-for="grupo in datos_grupos[paginacion - 1]"
    :key="grupo.id"
  >
    <div
    ...
    >
      <div class="flex justify-start w-3/4 items-center max-[400px]:w-full">
        <img
          :src="api_url + grupo.campos.logo_grupo"
          @click="mostrarLightBox(api_url + grupo.campos.logo_grupo)"
        ...
        >
          ...
          <p class="font-extrabold text-xl text-salte-900 max-[750px]:text-[18px]">
            {{ grupo.campos.nombre_grupo }}
          </p>
          <p class="font-normal text-sm text-gray-500 max-[750px]:text-[12px]">
            {{ grupo.campos.nombre_encargado }} {{ grupo.campos.apellido_encargado }}
          </p>
          <p class="font-normal text-sm text-gray-500 max-[750px]:text-[12px]">
            {{ grupo.campos.descripcion_grupo }}
          </p>
        </div>
      </div>
      ...
      >
        <button
          v-if="grupo.campos.visibilidad_grupo == 1"
        ...
        <button
          v-if="grupo.campos.visibilidad_grupo == 1"
          @click.prevent="estadoActualizar(grupo.id)"
        ...
        <button
          ...
          @click="borrarGrupoParroquial(grupo.id)"
          v-if="grupo.campos.visibilidad_grupo == 1"
        >
          <svg
            width="26px"
        ...
        <button
          @click="recuperarGrupoParroquial(grupo.id)"
        ...
        <div class="p-6 space-y-6 pb-14">
          ...
          >
            <div class="flex-col w-64">
              ...
              <input
                type="hidden"
                id="id_grupo_parroquial"
                v-model="form.id_grupo_parroquial"
              />
              <div class="relative z-0">
                <input
                  ...
                  id="nombre_grupo"
                  name="nombre_grupo"
                  v-model="form.nombre_grupo"
                  @input="validarNombreGrupo()"
                  required
                  maxlength="100"
                ...
                <label
                  ...
                  >Nombre - Grupo<span class="ml-1 text-sm"> * </span></label
                >
              </div>
              <div
                v-if="!validarNombreGrupo()"
              ...
              <div class="relative z-0 mt-6">
                ...
                <label
                  for="username"
                  class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                  >Nombre - Encargado</label
                >
              </div>
              <div
                v-if="!validarNombreEncargado()"
                class="flex mt-2 mb-0 text-sm text-red-400 bg-transparent"
                role="alert"
              >
                <svg
              ...
              <div class="relative z-0 mt-6">
                ...
                <label
                  for="username"
                  class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                  >Correo - Encargado<span class="ml-1 text-sm"> * </span></label
                >
              </div>
              <div class="flex-col pt-4 mt-4">
                <label for="" class="absolute text-sm text-gray-200"
                  >Categoría - Grupo<span class="ml-1 text-sm"> * </span></label
                >
                <select
                  id="underline_select"
                  v-model="form.id_categoria_grupo_parroquial"
                ...
                >
                  <option value="0" class="text-white bg-gray-700">
                    Seleccione una opción
                  </option>
                  <option
                    class="bg-gray-700"
                    v-for="categoria_grupo in roles"
                ...
                <div
                  v-if="form.id_categoria_grupo_parroquial == 0"
                  class="flex mt-2 mb-0 text-sm text-red-400 bg-transparent"
                  role="alert"
                >
                  <svg
            ...
            <div class="flex-col w-64">
              <div class="relative z-0">
                ...
                <label
                  ...
                  class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                  >Descripción - Grupo<span class="ml-1 text-sm"> * </span></label
                >
              </div>
              <div class="relative z-0 mt-6">
                <input
                  ...
                  maxlength="100"
                  @input="validarApellidoEncargado()"
                ...
                >
                <label
                  for="apellido_encargado"
                  class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                  >Apellido - Encargado</label
                >
              </div>
              <div
                v-if="!validarApellidoEncargado()"
                class="flex mt-2 mb-0 text-sm text-red-400 bg-transparent"
                role="alert"
              >
                <svg
              ...
              <div class="relative z-0 mt-6">
                ...
                >
                <label
                  for="telefono_encargado"
                  class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                  >Teléfono - Encargado<span class="ml-1 text-sm"> * </span></label
                >
              </div>
              <div
                v-if="!validarTelefono()"
                class="flex mt-2 mb-0 text-sm text-red-400 bg-transparent"
                role="alert"
              >
                <svg
                ...
                <div class="flex justify-start mt-2">
                  <label class="relative inline-flex items-center mb-5 cursor-pointer">
                    <input
                      ...
                      value=""
                      class="sr-only peer"
                      id="visibilidad_grupo"
                      name="visibilidad_grupo"
                      v-model="form.visibilidad_grupo"
                    />
                    <div
        ...
        <div class="flex items-start justify-between p-4 rounded-t">
          <div class="flex-col pt-4 ml-4">
            ...
            <p class="text-lg font-medium text-gray-400">
              Imagenes referentes a los grupos parroquiales
            </p>
          </div>
          <button
            type="button"
        ...
        <div class="flex-col p-8 space-y-6">
          <div class="flex items-center justify-between">
            <p class="text-gray-100">
              Ingrese las imagenes que desee mostrar para sus grupos parroquiales publicos
            </p>
            <button
              class="flex items-center justify-center h-10 rounded-lg bg-purpleLogin hover:bg-lightPurpleLogin w-14"
          ...
          <div class="grid w-full grid-cols-5 gap-5 px-5 py-5 h-80 image-container">
            <div
              ...
              :key="item.id_imagen_grupo_parroquial"
              class="relative"
            >
              <img :src="api_url + item.archivo_imagen" class="w-32 h-32 rounded-lg" />
              <div
                @click="agregarImagenBorrada(item.id_imagen_grupo_parroquial)"
          ...
          <div class="flex items-center justify-between mt-6">
            <div class="relative z-0 w-64">
              <input
                ...
                id="grupo"
                name="grupo"
                v-model="nombre_grupo_parroquialref"
                required
                readonly
                maxlength="100"
                class="block py-2.5 px-0 w-full text-sm text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 peer focus:border-moradoClaroLogin peer"
              ...
              <label
                for="grupo"
                class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                >Grupo parroquial</label
              >
            </div>
            <button
              class="w-32 h-10 mt-4 text-white rounded-lg bg-space"
...
async function crearGrupoParroquial() {
  ...
  if (
    ...
    try {
      ...
      await axios
        .post("/grupos_parroquia", FORMDATA, {
          headers: {
    ...
    await axios
      ...
      .then((res) => {
        ...
        form.value = {
          ...
          id_categoria_grupo_parroquial:
            res.data.data.campos.id_categoria_grupo_parroquial,
        };
...
async function actualizarGrupoParroquial() {
  ...
  if (
    ...
    try {
      ...
      await axios
        .post("/grupos_parroquia_update/" + id, FORMDATA, {
          headers: {
            "Content-Type": "multipart/form-data",
            Authorization: `Bearer ${token.value}`,
          },
...
function agregarImagenBorrada(id) {
  ...
  data_imagenes.value = data_imagenes.value.filter(
    (item) => item.id_imagen_grupo_parroquial != id
  );
}
