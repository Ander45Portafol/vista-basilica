<template>
  <div
    ...
    v-for="personal in datos_personal[paginacion - 1]"
    :key="personal.id"
  >
    <div
    ...
    >
      <div class="flex justify-start w-3/4 items-center max-[400px]:w-full">
        ...
        >
          ...
          <p class="font-normal text-sm mt-1 text-gray-500 max-[750px]:text-[12px]">
            {{ personal.campos.telefono_personal }}
          </p>
      ...
      >
        <button
          ...
          @click.prevent="estadoActualizar(personal.id)"
        >
          <svg
            width="26px"
            height="26px"
        ...
        <button
          ...
          @click="borrarPersonal(personal.id)"
          v-if="personal.campos.visibilidad_personal == 1"
        >
          <svg
            width="26px"
        ...
        <button
          @click="recuperarUnPersonal(personal.id)"
          ...
          >
            <div class="flex-col w-64">
              ...
              <div class="relative z-0">
                <input
                  type="text"
                  v-model="form.nombre_personal"
                  id="nombre_personal"
                  name="nombre_personal"
                  maxlength="100"
                  required
                  @input="validarNombrePersonal()"
              ...
              >
                ...
                <div>
                  El nombre del personal solo permite
              ...
              <div class="relative z-0 mt-6">
                ...
                >
                <label
                  for="telefono_personal"
                  class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                  >Telefono - Personal</label
                >
              </div>
              <div
              ...
              <div class="pt-4 mt-4 flex-col">
                <label for="" class="absolute text-gray-200 text-sm"
                  >Tipo personal<span class="text-sm ml-1"> * </span></label
                >
                <select
                  id="underline_select"
                ...
                >
                  ...
                  <option
                    class="bg-gray-700"
                    v-for="tipo_personal in tipo_personales"
            ...
            <div class="flex-col w-64">
              <div class="relative z-0">
                <input
                  type="text"
                  v-model="form.apellido_personal"
                  id="apellido_personal"
                  name="apellido_personal"
                  maxlength="100"
                  required
                  @input="validarApellidoPersonal()"
                  class="block py-2.5 px-0 w-full text-sm text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 peer focus:border-moradoClaroLogin peer"
                  placeholder=" "
                  autocomplete="off"
                />
              ...
              >
                ...
                <div>
                  El apellido del personal solo permite
                  <span class="font-medium"> letras.</span>
                </div>
              </div>
              <div class="relative z-0 mt-6">
...
async function crearPersonal() {
  ...
  if (
    ...
    try {
      ...
      FORM_DATA.append("apellido_personal", form.value.apellido_personal);
      FORM_DATA.append("telefono_personal", form.value.telefono_personal);
      FORM_DATA.append("correo_personal", form.value.correo_personal);
      FORM_DATA.append("visibilidad_personal", form.value.visibilidad_personal ? 1 : 0);
      FORM_DATA.append("id_tipo_personal", form.value.id_tipo_personal);
      //Se realiza la petición axios mandando la ruta y el formData
      await axios
        .post("/personal/", FORM_DATA, {
          headers: {
            Authorization: `Bearer ${token.value}`,
          },
        })
...
async function actualizarPersonal() {
  ...
  if (
    ...
    try {
      ...
      //Se realiza la petición axios mandando la ruta y el formData
      await axios
        .post("/personal_update/" + id, FORM_DATA, {
          headers: {
            Authorization: `Bearer ${token.value}`,
          },
        })
