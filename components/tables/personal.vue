<template>
    <div class="contained-data flex-col" v-for="personal in datos_personal[paginacion - 1]" :key="personal.id">
        <div
            ...
            <div
                ...
                <button class="h-10 w-10 rounded-md flex items-center justify-center max-[400px]:mx-4 editbtn" id="btnedit"
                    v-if="personal.campos.visibilidad_personal == 1" @click.prevent="estadoActualizar(personal.id)">
                ...
                <div class="p-6 space-y-6 pb-10">
                    <form action="" id="formModal" @submit.prevent="submitForm()" class="flex justify-evenly">
                        <div class="flex-col w-64">
                            ...
                            <div class="relative z-0 mt-6">
                                <input type="text" v-model="form.telefono_personal" id="telefono_personal"
                                    name="telefono_personal" maxlength="9" @input="validarTelefono()"
                                    class="block py-2.5 px-0 w-full text-sm text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 peer focus:border-moradoClaroLogin peer"
                                    placeholder=" " autocomplete="off" />
                        ...
                        <div class="flex-col w-64">
                            ...
                            <div v-if="!validarApellidoPersonal()"
                                class="flex mt-2 mb-0 text-sm text-red-400 bg-transparent" role="alert">
                                <svg aria-hidden="true" class="flex-shrink-0 inline w-5 h-5 mr-3" fill="currentColor"
                                    viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                            ...
                            <div class="relative z-0 mt-6">
                                <input type="email" v-model="form.correo_personal" id="correo_personal"
                                    name="correo_personal" maxlength="100"
                                    class="block py-2.5 px-0 w-full text-sm text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 peer focus:border-moradoClaroLogin peer"
                                    placeholder=" " autocomplete="off" />
                        ...
                        <div class="modal-buttons flex justify-end items-end">
                            ...
                            <button id="btnModalAdd" type="submit" :disabled="!validarNombrePersonal() ||
                            ...
                            <button id="btnModalUpdate" type="submit" :disabled="!validarNombrePersonal() ||
                                !validarApellidoPersonal() ||
                                !validarTelefono() ||
                                form.id_tipo_personal == 0
                                " class="h-10 ml-2 w-10 rounded-lg flex justify-center items-center">
