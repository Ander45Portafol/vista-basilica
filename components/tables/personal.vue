<template>
   <div class="data-contained flex-col" v-for="personal in datos_personal[paginacion - 1]" :key="personal.id">
      ...
      <div
         ...
         <button class="h-10 w-10 rounded-md flex items-center justify-center max-[400px]:mx-4 editbtn" id="btnedit"
            @click="leerUnPersonal(personal.id)" v-if="personal.campos.visibilidad_personal == 1">
               ...
               <form action="" id="formModal" @submit.prevent="submitForm()" class="flex justify-evenly">
                  <div class="flex-col w-64">
                     ...
                     <div class="relative z-0">
                        <input type="text" v-model="form.nombre_personal" id="nombre_personal" name="nombre_personal"
                     ...
                     <div class="relative z-0 mt-6">
                        <input type="text" v-model="form.telefono_personal" id="telefono_personal" name="telefono_personal"
                           class="block py-2.5 px-0 w-full text-sm text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 peer focus:border-moradoClaroLogin peer"
                           placeholder=" " autocomplete="off" />
                  ...
                  <div class="flex-col w-64">
                     <div class="relative z-0">
                        <input type="text" v-model="form.apellido_personal" id="apellido_personal" name="apellido_personal"
                           class="block py-2.5 px-0 w-full text-sm text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 peer focus:border-moradoClaroLogin peer"
                           placeholder=" " autocomplete="off" />
                  ...
                  <div class="flex-col mt-8">
                     ...
                     <div class="flex justify-start mt-2">
                        <label class="relative inline-flex items-center mb-5 cursor-pointer">
                           <input type="checkbox" value="" class="sr-only peer" v-model="form.visibilidad_personal">
                           <div
