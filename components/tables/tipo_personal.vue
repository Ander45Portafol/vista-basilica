<template>
  ...
  <div
    ...
    v-for="tipos_personale in datos_tipo_personal[paginacion - 1]"
  ...
  >
    ...
    >
      ...
      >
        ...
        <button
          @click="recuperarTipoPersonal(tipos_personale.id)"
