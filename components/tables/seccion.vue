<template>
  <div
    ...
    v-for="seccione in datos_secciones[paginacion - 1]"
    :key="seccione.id"
  >
    <div
    ...
    >
      <div class="flex justify-start w-3/4 items-center max-[400px]:w-full">
        ...
        >
          ...
          <p
            v-if="seccione.campos.ubicacion_seccion"
            class="font-semibold text-sm text-gray-500 max-[750px]:text-[12px]"
          >
            Ubicacion de la seccion: {{ seccione.campos.ubicacion_seccion }}
          </p>
          <p
            v-if="seccione.campos.subtitulo_seccion"
          ...
          <p
            v-if="seccione.campos.descripcion_seccion"
            class="font-normal text-sm text-gray-500 max-[750px]:text-[12px]"
          >
      ...
      >
        <button
          ...
          id="btnedit"
          v-if="seccione.campos.visibilidad_seccion == 1"
          @click.prevent="estadoActualizar(seccione.id)"
        >
          <svg
            width="26px"
            height="26px"
        ...
        <button
          ...
          @click="borrarSeccion(seccione.id)"
          v-if="seccione.campos.visibilidad_seccion == 1"
        >
          <svg
            width="26px"
        ...
        <button
          @click="recuperarUnaSeccion(seccione.id)"
          ...
          <form id="formModal" @submit.prevent="submitForm()" class="flex justify-evenly">
            <div class="flex-col w-64">
              ...
              <div class="relative z-0 mt-6">
                <input
                  type="text"
                  v-model="form.subtitulo_seccion"
                ...
                >
                <label
                  for="subtitulo_seccion"
                  class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                  >Subtitulo - Seccion</label
                >
                <!-- Se coloca un if que evalua si la función de validar es false, así se muestra la alerta solo cuando es false -->
                <div
                  v-if="!validarSubtituloSeccion()"
                  class="flex mt-2 mb-0 text-sm text-red-400 bg-transparent"
                  role="alert"
                >
                  <svg
              ...
              <div class="relative z-0 mt-6">
                <textarea
                  type="text"
                  v-model="form.descripcion_seccion"
              ...
              <div class="relative z-0 mt-6">
                <input
                  type="number"
                  v-model="form.ubicacion_seccion"
                  id="ubicacion_seccion"
                  min="1"
                  max="99"
                  maxlength="250"
                ...
                />
                <label
                  for="ubicacion_seccion"
                  class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                  >Ubicación - Seccion</label
                >
              </div>

              <div class="pt-4 mt-4 flex-col">
                <label for="" class="absolute text-gray-200"
                  >Pagina - Asignada<span class="text-sm ml-1"> * </span></label
                >
                <select
                  id="underline_select"
                  v-model="form.id_pagina"
                ...
                <div class="flex justify-start mt-2">
                  <label class="relative inline-flex items-center mb-5 cursor-pointer">
                    <input
                      type="checkbox"
                      value="false"
                      v-model="form.visibilidad_seccion"
                      class="sr-only peer"
                    />
                    <div
