        ...
        <div
            ...
            <div class="flex justify-start w-3/4 items-center max-[400px]:w-full">
                ...
                <div
                    ...
                    <p v-if="seccione.campos.subtitulo_seccion && seccione.campos.subtitulo_seccion != 'null'"
                    ...
                    <p v-if="seccione.campos.descripcion_seccion && seccione.campos.descripcion_seccion != 'null'"
                        class="font-normal text-sm text-gray-500 max-[750px]:text-[12px]">
