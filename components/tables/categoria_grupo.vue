<template>
  ...
  <div
    ...
    v-for="categoria_grupo in datos_categoria_grupo[paginacion - 1]"
  ...
  >
    ...
    >
      ...
      >
        ...
        <button
          @click="recuperarUnaCategoriaGrupo(categoria_grupo.id)"
          ...
          <form action="" @submit.prevent="submitForm()" class="flex justify-center">
            <div class="flex-col w-64">
              ...
              <div class="relative z-0 mt-6">
                <input
                  type="text"
                  id="nombre_categoria_grupo"
                  name="nombre_categoria_grupo"
                  required
                  maxlength="100"
                  @input="validarNombreCategoriaGrupo()"
                ...
                <label
                  ...
                  >Nombre - Categoria - Grupo<span class="text-sm ml-1"> * </span></label
                >
              </div>
              <div
                v-if="!validarNombreCategoriaGrupo()"
                ...
                <div class="flex justify-start mt-2">
                  <label class="relative inline-flex items-center mb-5 cursor-pointer">
                    <input
                      ...
                      value=""
                      class="sr-only peer"
                      id="visibilidad_categoria"
                      name="visibilidad_categoria"
                      v-model="form.visibilidad_categoria"
                    />
                    <div
