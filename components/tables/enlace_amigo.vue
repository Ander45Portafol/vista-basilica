<template>
  ...
  <div
    ...
    v-for="enlace in datos_enlaces[paginacion - 1]"
    :key="enlace.id"
  >
    <div
    ...
    >
      <div class="flex justify-start w-3/4 items-center max-[400px]:w-full">
        <img
          :src="api_url + enlace.campos.imagen_enlace"
      ...
      >
        <button
          ...
          id="btnedit"
          v-if="enlace.campos.visibilidad_enlace == 1"
          @click.prevent="estadoActualizar(enlace.id)"
        >
          <svg
            width="26px"
            height="26px"
        ...
        <button
          @click="recuperarUnEnlace(enlace.id)"
            ...
            <div class="flex-col w-64">
              ...
              <div class="relative z-0">
                ...
                <label
                  ...
                  >Título - Enlace<span class="text-sm ml-1"> * </span></label
                >
              </div>
              <div
                v-if="!validarTitulo()"
              ...
              <div class="relative z-0 mt-6">
                <input
                  ...
                  placeholder=" "
                  autocomplete="off"
                  v-model="form.enlace_amigo"
                />
                <label
                  for="enlace_amigo"
                  class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                  >Enlace - Amigo<span class="text-sm ml-1"> * </span></label
                >
              </div>
              ...
              <div class="relative z-0 mt-6">
                <textarea
                  ...
                  placeholder=" "
                  autocomplete="off"
                  v-model="form.descripcion_enlace"
                />
                <span
                ...
                >
                <label
                  for="descripcion_enlace"
                  class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                  >Descripción - Enlace</label
                >
              </div>
                ...
                <div class="flex justify-start mt-2">
                  <label class="relative inline-flex items-center mb-5 cursor-pointer">
                    <input
                      ...
                      value=""
                      class="sr-only peer"
                      id="visibilidad_enlace"
                      name="visibilidad_enlace"
