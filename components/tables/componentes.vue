<template>
  ...
  <div
    ...
    v-for="componente in datos_componentes[paginacion - 1]"
    :key="componente.id"
  >
    <div
    ...
    >
      <div class="flex justify-start w-3/4 items-center max-[400px]:w-full">
        ...
        >
          <p class="font-extrabold text-xl text-salte-900 max-[750px]:text-[18px]">
            {{ componente.campos.nombre_componente }}
          </p>
          <p class="font-normal text-sm mt-1text-gray-500 max-[750px]:text-[12px]">
            Tipo de componente:
            <span class="font-semibold |">{{ componente.tipos.tipo_componente }}</span>
          </p>
      ...
      >
        ...
        <button
          ...
          @click="borrarComponente(componente.id)"
          v-if="componente.campos.visibilidad_componente == 1"
        >
          <svg
            width="26px"
        ...
        <button
          @click="recuperarUnComponente(componente.id)"
        ...
        <div class="relative rounded-lg shadow modal">
          ...
          <div class="space-y-6 flex justify-evenly pb-10">
            <div
              class="flex-col"
              id="visualizacion"
              v-if="pagina_modal == 1 || pagina_modal == ''"
            >
                    ...
                    <div class="absolute z-30 flex -translate-x-1/2 bottom-5 left-1/2">
                      <div v-for="item in laminas_slider">
                        <button
                          ...
                          type="button"
                          class="w-3 ml-3 h-3 rounded-full"
                        ></button>
                      </div>
                    </div>
                    <!-- Slider controls -->
              ...
              <form
                @submit.prevent="actualizarComponente"
                  ...
                  <div class="flex items-end justify-center">
                    <div class="relative z-0 mr-10">
                      ...
                      <label
                        ...
                        >Nombre - Componente<span class="text-sm ml-1"> * </span></label
                      >
                    </div>
                    <div class="mt-2 flex-col mr-10">
                      <label for="" class="text-sm absolute text-gray-200"
                        >Escoger sección<span class="text-sm ml-1"> * </span></label
                      >
                      <select
                        id="underline_select"
                      ...
                      >
                        <option value="0" class="bg-gray-700">
                  ...
                  <div class="flex items-center justify-start mt-5">
                    <div class="relative z-0 mr-10">
                      ...
                      <label
                        ...
                        class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                        >Ubicación - Componente<span class="text-sm ml-1">
                          *
                        </span></label
                      >
                    </div>
            ...
            <form
              @submit.prevent="formAccion"
              class="w-full py-6 px-10"
              id="s_formulario"
              v-else
            >
          ...
          <div class="flex items-center justify-center">
            <input
              type="number"
              class="mb-10 w-16 text-right"
              v-model="pagina_modal"
              min="1"
      ...
      <div class="relative w-full max-w-4xl max-h-full">
        ...
        <div class="relative rounded-lg shadow modal">
          ...
          <div class="space-y-6 flex justify-evenly pb-10">
            ...
            >
              <div
                v-if="laminas_acordeon && laminas_acordeon.length == 0"
        ...
        <div class="relative rounded-lg shadow modal">
          ...
          <div class="flex items-start justify-between p-4 rounded-t">
            <div class="flex-col pt-4 ml-4">
              <p class="text-xl font-bold text-gray-100" id="titulo_modal-banner">
                Banner
              </p>
          ...
          <div class="flex pb-10 space-y-6 justify-evenly">
                  ...
                  <div class="flex items-center justify-start mt-5">
                    <div class="relative z-0 mr-10">
                      ...
                      <label
                        for="ubicacion_componente"
                        class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                        >Ubicación - Componente<span class="ml-1 text-sm">
                          *
                        </span></label
                      >
                    </div>
            ...
            <form
              @submit.prevent="actualizarLamina"
...
async function leerComponente(id) {
  try {
    ...
    if (res.data) {
      ...
      form_componente.value.visibilidad_componente =
        res.data.campos.visibilidad_componente;
      ...
      case "Imagen - Texto V1":
        if (res.data[0]) {
          ...
          imagen_preview2.value =
            RUTA_IMAGENES_LAMINAS + form_banner.value.archivo_imagen;
        }
        break;
...
async function actualizarComponente() {
  try {
    ...
    const res = await axios.post(
      "/componentes_update/" + form_componente.value.id_componente,
      FORM_DATA,
      {
        headers: {
          Authorization: `Bearer ${token.value}`,
    ...
    if (res.data.data) {
      ...
      form_componente.value.nombre_componente =
        res.data.data.componente.nombre_componente;
      form_componente.value.ubicacion_componente =
        res.data.data.componente.ubicacion_componente;
      ...
      form_componente.value.id_tipo_componente =
        res.data.data.componente.id_tipo_componente;
      form_componente.value.id_seccion = res.data.data.componente.id_seccion;
      form_componente.value.nombre_tipo_componente =
        res.data.data.componente.tipos.tipo_componente;
    }
  ...
  if (pagina_modal.value != "") {
    if (form_componente.value.nombre_tipo_componente == "Slider") {
      if (!laminas_slider.value && pagina_modal.value > 2) {
        ...
        form_laminas_slider.value.id_lamina_componente =
          laminas_slider.value[pagina_modal.value - 2].id;
        form_laminas_slider.value.archivo_imagen =
          laminas_slider.value[pagina_modal.value - 2].campos.archivo_imagen;
        ...
        form_laminas_slider.value.titulo_lamina =
          laminas_slider.value[pagina_modal.value - 2].campos.titulo_lamina;
        form_laminas_slider.value.subtitulo_lamina =
          laminas_slider.value[pagina_modal.value - 2].campos.subtitulo_lamina;
        form_laminas_slider.value.identificador_lamina =
          laminas_slider.value[pagina_modal.value - 2].campos.identificador_lamina;
        form_laminas_slider.value.visibilidad_lamina =
          laminas_slider.value[pagina_modal.value - 2].campos.visibilidad_lamina;
      }
      ...
      if (!laminas_acordeon.value && pagina_modal.value > 2) {
        ...
        form_accion.value = "Actualizar";
        form_laminas_acordeon.value.id_lamina_componente =
          laminas_acordeon.value[pagina_modal.value - 2].id;
        form_laminas_acordeon.value.titulo_lamina =
          laminas_acordeon.value[pagina_modal.value - 2].campos.titulo_lamina;
        form_laminas_acordeon.value.contenido_lamina =
          laminas_acordeon.value[pagina_modal.value - 2].campos.contenido_lamina;
        form_laminas_acordeon.value.identificador_lamina =
          laminas_acordeon.value[pagina_modal.value - 2].campos.identificador_lamina;
        form_laminas_acordeon.value.visibilidad_lamina =
          laminas_acordeon.value[pagina_modal.value - 2].campos.visibilidad_lamina;
      }
    } else if (
      form_componente.value.nombre_tipo_componente == "Imagen - Texto V1" ||
      form_componente.value.nombre_tipo_componente == "Imagen - Texto V2"
    ) {
...
async function actualizarLamina() {
  ...
  if (form_componente.value.nombre_tipo_componente == "Slider") {
    try {
      ...
      const res = await axios.post(
        "/laminas_update/" + form_laminas_slider.value.id_lamina_componente,
        FORM_DATA,
        {
          headers: {
            "Content-Type": "multipart/form-data",
    ...
    try {
      ...
      const res = await axios.post(
        "/laminas_update/" + form_laminas_acordeon.value.id_lamina_componente,
        FORM_DATA,
        {
          headers: {
            Authorization: `Bearer ${token.value}`,
    ...
    try {
      ...
      if (form_banner.value.id_lamina_componente) {
        const res = await axios.post(
          "/laminas_update/" + form_banner.value.id_lamina_componente,
          FORM_DATA,
          {
            headers: {
              "Content-Type": "multipart/form-data",
