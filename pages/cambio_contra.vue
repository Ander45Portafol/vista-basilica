...
<template>
  <div
    class="h-screen w-screen flex flex-col justify-center items-center absolute left-0 bg-gradient"
  >
    ...
    >
      ...
      >
        ...
        <p class="text-white mb-5">
          Si tienes alguna dificultad o necesitas asistencia adicional, no dudes en
          contactarnos. Estamos aquí para ayudarte a recuperar el acceso a tu cuenta
          de manera segura.
        </p>
        <div class="flex p-4 mb-4 text-sm text-black rounded-lg bg-blue-50" role="alert">
          <div>
            <span class="font-medium text-base"
              >Para garantizar la seguridad de tu cuenta, te recomendamos tener en cuenta
      ...
      <form
        class="min-[1201px]:w-1/4 max-[1200px]:w-1/2 max-[700px]:w-full max-[700px]:mb-24"
      ...
      >
        <div class="relative z-0 mt-10 mb-4 mx-12">
          ...
          <label
            ...
            >Nueva contraseña <span class="text-sm ml-1"> * </span></label
          >
        </div>
        <div class="relative z-0 mt-10 mb-4 mx-12">
          <input
        ...
        <div class="mx-12">
          <button
            type="submit"
            class="w-full py-3 mt-10 text-center text-white font-medium text-lg bg-purpleLogin rounded-lg"
          >
            Cambiar contraseña
          </button>
        </div>
...
.bg-gradient {
  background: linear-gradient(
    180deg,
    rgba(63, 66, 128, 0.71) 0%,
    rgba(49, 50, 71, 0.79) 100%
  );
