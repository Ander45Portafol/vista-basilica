                ...
                <div
                    ...
                    <div class="flex justify-start w-3/4 items-center max-[400px]:w-full">
                        ...
                        <div
                            ...
                            <p class="font-extrabold text-xl text-salte-900 max-[750px]:text-[18px]">Enlace - ONU</p>
                            <p class="font-normal text-sm mt-1text-gray-500 max-[750px]:text-[12px]"><a
                                    href="#">https://www.un.org/es/</a></p>
                            <p class="font-normal text-sm text-gray-500 max-[750px]:text-[12px]">Este enlace redirige a la
