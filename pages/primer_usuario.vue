      ...
      <div class="w-3/4 flex-col mt-20">
        ...
        <div class="flex mr-20 mt-20 justify-between">
          <div class="flex-col">
            ...
            <div
              v-if="!validarNombre()"
              class="flex w-64 mt-2 mb-0 text-sm text-red-400 bg-transparent"
              role="alert"
            >
              <div class="flex-col">
            ...
            <div class="relative z-0 mt-16 w-72">
              ...
              <label
                ...
                class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                >Correo Eletronico<span class="text-sm ml-1"> * </span></label
              >
            </div>
            <div class="pt-4 mt-12 flex-col w-72">
          ...
          <div class="flex-col">
            ...
            >
              <div class="flex-col">
                El apellido de la persona solo permite
            ...
            <div
              ...
              class="flex w-72 mt-2 mb-0 text-sm text-red-400 bg-transparent"
              role="alert"
            >
              <svg
                aria-hidden="true"
            ...
            <div
              ...
              class="flex mt-2 mb-0 w-64 text-sm text-red-400 bg-transparent"
              role="alert"
            >
              <svg
                aria-hidden="true"
        ...
        <div class="flex justify-start items-end h-56">
          <div class="flex-col">
            <p class="font-extralight text-base text-gray-400">
              Llena los campos establecidos con la información solicitada de acuerdo al
              usuario que
            </p>
            <p class="font-extralight text-base text-gray-400">deseas registrar.</p>
            <p class="font-extralight text-base text-gray-400 mt-4">
              Una vez ingresada la información, solo podrás cambiarla dentro del sistema.
            </p>
          </div>
        </div>
      </div>
