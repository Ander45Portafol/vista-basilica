<template>
  <div class="mt-4 principal">
    ...
    <div class="flex mt-10 ml-8">
        ...
        >
          ...
          >
            ...
            <li v-for="item in select_tipos_categorias">
              <p
                @click="filtrarTiposComponentes(item.categoria_tipo_componente)"
                class="block px-4 py-2 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
              >
                {{ item.categoria_tipo_componente }}
              </p>
            </li>
          </ul>
        </div>
        <div
          v-if="tipos_componentes_filtrados"
          class="flex-col pr-4 mt-6 overflow-y-scroll tipo_componente h-2/4"
        >
          <div
            @click="seleccionarTipoComponente(item.id_tipo_componente)"
          ...
          >
            <div class="text-center flex-column">
              <img
                :src="RUTA_IMAGENES + item.icono_tipo_componente"
                :alt="item.tipo_componente"
              />
              <p class="mt-3 font-semibold text-purpleLogin">
      ...
      <div
        v-if="!seleccionando_componente && informacion_componente_seleccionado"
        class="flex-col w-full h-screen ml-10"
      >
        <div class="relative w-full ml-10 slider_example">
          <img
            :src="RUTA_IMAGENES + informacion_componente_seleccionado.preview"
            :alt="informacion_componente_seleccionado.nombre"
            class="w-9/12 m-auto rounded-lg"
          />
        </div>
          ...
          <div class="w-2/4 px-10 mt-4">
            <div class="flex-col w-full h-32 bg-gray-300 rounded-lg">
              <p class="pt-2 pl-4 text-lg font-semibold text-gray-900">
                {{ informacion_componente_seleccionado.nombre }}
              </p>
      ...
      <div v-else class="flex items-center justify-center w-full h-screen ml-10">
        <div class="text-center flex-column">
          ...
          <p class="text-purpleLogin font-semibold text-lg mb-[24%]">
            Por favor, selecciona un tipo de componente para acceder a su información
            correspondiente.
          </p>
        </div>
      </div>
      ...
      <div class="relative rounded-lg shadow modal">
        ...
        <div class="flex items-start justify-between p-4 rounded-t">
          <div class="flex-col pt-4 ml-4">
            ...
            <p class="text-base font-medium text-gray-400" id="subtitulo_modal">
              Componente-Lamina
            </p>
          </div>
          <button
            type="button"
            class="bg-transparent rounded-lg p-1.5 ml-auto items-center border-none"
            id="btnclose"
          >
            <svg
              width="24px"
        ...
        <div class="flex pb-10 space-y-6 justify-evenly">
                ...
                <div class="relative">
                  ...
                  <div class="relative overflow-hidden rounded-lg h-[450px]">
                    <div v-for="item in laminas_slider">
                      <div
                        v-if="item.campos.visibilidad_lamina"
                        :id="'carouselP-item-' + item.campos.identificador_lamina"
                        class="absolute inset-0 z-20 transition-all duration-700 ease-in-out transform translate-x-0"
                        data-carousel-item=""
                      >
                        <img
                          :src="RUTA_IMAGENES_LAMINAS + item.campos.archivo_imagen"
                          class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                          alt="..."
                        />
                        <div class="relative top-[300px] px-4 py-2 opacity-100">
                          <p class="ml-24 text-3xl font-bold text-left text-white">
                            {{ item.campos.titulo_lamina }}
                          </p>
                          <p class="ml-24 text-xl font-bold text-left text-white">
                            {{ item.campos.subtitulo_lamina }}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="absolute z-30 flex -translate-x-1/2 bottom-5 left-1/2">
                    <div v-for="item in laminas_slider">
                      <button
                        ...
                        type="button"
                        class="w-3 h-3 ml-3 rounded-full"
                      ></button>
                    </div>
                  </div>
                  <!-- Slider controls -->
                  <button
                    id="data-carouselP-prev"
                    type="button"
                    class="absolute top-0 left-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none"
                  >
                    <span
              ...
              <div class="flex-column">
                <div class="flex items-end justify-center">
                  <div class="relative z-0 mr-10">
                    ...
                    <label
                      ...
                      >Nombre - Componente<span class="ml-1 text-sm"> * </span></label
                    >
                  </div>
                  <div class="flex-col mt-2 mr-10">
                    <label for="" class="absolute text-sm text-gray-200"
                      >Escoger sección<span class="ml-1 text-sm"> * </span></label
                    >
                    <select
                      id="underline_select"
                      v-model="form_componente.id_seccion"
                      :disabled="read_only"
                    ...
                    <div
                      v-if="form_componente.id_seccion == 0"
                ...
                <div class="flex items-center justify-start mt-5">
                  <div class="relative z-0 mr-10">
                    ...
                    />
                    <label
                      for="ubicacion_componente"
                      class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                      >Ubicación - Componente<span class="ml-1 text-sm"> * </span></label
                    >
                  </div>
                  <div class="flex-column">
                    <label for="visibilidad_componente" class="text-sm text-gray-200"
                    ...
                    <div class="flex justify-start mt-2">
                      ...
                      >
                        <input
                          ...
                          class="sr-only peer"
                          :disabled="read_only"
                          id="visibilidad_componente"
                          name="visibilidad_componente"
          ...
          <form
            @submit.prevent="crearLamina"
            class="w-full px-10 py-6"
            id="s_formulario"
            v-else
          >
            <div class="flex justify-between w-full">
              <div class="flex-col mt-20">
                <button
                  class="flex items-center justify-center w-16 h-12 mr-6 bg-space rounded-xl"
              ...
              <div class="flex-col w-72">
                ...
                <div class="relative z-0 mt-8">
                  <input
                    type="text"
                    id="subtitulo_lamina"
                    name="subtitulo_lamina"
                    required
                    :readonly="read_only_laminas"
                    v-model="form_laminas_slider.subtitulo_lamina"
                    @input="cambiosGuardados"
                    maxlength="100"
                    class="block py-2.5 px-0 w-full text-sm text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 peer focus:border-lightPurpleLogin peer"
                    placeholder=" "
                  ...
                  >
                  <label
                    for="subtitulo_lamina"
                    class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                    >Subtítulo - lamina</label
                  >
                </div>
                <div class="relative z-0 mt-8">
                  <input
                    type="number"
                    id="identificador_lamina"
                    name="identificador_lamina"
                    required
                    :readonly="read_only_laminas"
                    v-model="form_laminas_slider.identificador_lamina"
                    @input="cambiosGuardados"
                    min="1"
                    max="99"
                    class="block py-2.5 px-0 w-full text-sm text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 peer focus:border-lightPurpleLogin peer"
                  ...
                  />
                  <label
                    for="identificador_lamina"
                    class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                    >Identificador - lamina</label
                  >
                </div>
                <div class="flex-col mt-8">
                  <label for="" class="text-sm text-gray-200"
                    >Visibilidad - lamina *</label
                  >
                  <div class="flex justify-start mt-2">
              ...
              <div class="flex-col ml-14">
                ...
                <div
                  class="h-52 w-48 border-2 border-slate-900 rounded-lg cursor-pointer relative max-[630px]:m-auto"
                  @click="SELECCIONAR_ARCHIVO"
            ...
            <div class="flex items-center justify-end">
              <button
                type="button"
                id="btnModalClear"
                @click="limpiarFormLaminasSlider"
                :disabled="read_only_laminas"
  ...
  >
    <div class="relative w-full max-w-4xl max-h-full">
      ...
      <div class="relative rounded-lg shadow modal">
        ...
        <div class="flex items-start justify-between p-4 rounded-t">
          <div class="flex-col pt-4 ml-4">
            <p class="text-xl font-bold text-gray-100" id="titulo_modal_acordeon">
              Acordeón
            </p>
            <p class="text-base font-medium text-gray-400" id="subtitulo_modal_acordeon">
              Componente-Lamina
            </p>
          </div>
          <button
        ...
        <div class="flex pb-10 space-y-6 justify-evenly">
          <div
            class="flex-col"
            id="visualizacion_acordeon"
            v-if="pagina == 1 || pagina == ''"
          >
            <div
              v-if="!laminas_acordeon"
            ...
            >
              ...
              >
                <div v-for="number in 5">
                  ...
                  <div
                    :id="'accordion-color-body-' + number"
                    class="hidden"
                ...
                <div v-for="item in laminas_acordeon">
                  ...
                  >
                    <button
                      ...
                      :data-accordion-target="
                        'accordion-preview-body-' + item.campos.identificador_lamina
                      "
                      aria-expanded="true"
                      :aria-controls="
                        'accordion-preview-body-' + item.campos.identificador_lamina
                  ...
                  <div>
                    <div
                      ...
                      class="hidden"
                      :aria-labelledby="
                        'accordion-preview-heading-' + item.campos.identificador_lamina
                      "
                    >
                      <div
                        class="p-5 w-[700px] border border-b-0 border-lightPurpleLogin"
                      >
                        <p class="mb-2 text-white">
                          {{ item.campos.contenido_lamina }}
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div class="flex-column">
                ...
                <div class="flex items-center justify-start mt-5">
                  <div class="relative z-0 mr-10">
                    <input
                      type="number"
                      id="ubicacion_componente_acordeon"
                  ...
                  <div class="flex-column">
                    <label
                      for="visibilidad_componente_acordeon"
          ...
          >
            <div class="flex justify-between w-full">
              ...
              <div class="flex-col w-2/4">
                <div class="relative z-0">
                  <input
                    type="text"
                    id="titulo_lamina_acordeon"
                    name="titulo_lamina_acordeon"
                    required
                    maxlength="100"
                    v-model="form_laminas_acordeon.titulo_lamina"
                    @input="cambiosGuardados"
                    :readonly="read_only_laminas"
                    class="block py-2.5 px-0 w-full text-sm text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 peer focus:border-lightPurpleLogin peer"
                    placeholder=" "
                ...
                <div class="relative z-0 mt-8">
                  <textarea
                    id="contenido_lamina_acordeon"
                    name="contenido_lamina_acordeon"
                    required
                    :readonly="read_only_laminas"
                    v-model="form_laminas_acordeon.contenido_lamina"
                    @input="cambiosGuardados"
                    maxlength="1000"
                  ...
                  >
                  <label
                    for="contenido_lamina_acordeon"
                    class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                    >Contenido - lamina</label
                  >
                </div>
                <div class="relative z-0 mt-8">
                  <input
                    type="number"
                    id="identificador_lamina_acordeon"
                    name="identificador_lamina_acordeon"
                    required
                    :readonly="read_only_laminas"
                    v-model="form_laminas_acordeon.identificador_lamina"
                    @input="cambiosGuardados"
                    min="1"
                    max="99"
                    class="block py-2.5 px-0 w-full text-sm text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 peer focus:border-lightPurpleLogin peer"
                  ...
                  />
                  <label
                    for="identificador_lamina_acordeon"
                    class="absolute text-sm text-gray-200 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                    >Identificador - lamina</label
                  >
                </div>
            ...
            <div class="flex items-center justify-end">
              <button
                type="button"
                id="btnModalClearAcordeon"
                @click="limpiarFormLaminasAcordeon"
                :disabled="read_only_laminas"
                class="h-10 w-10 rounded-lg flex justify-center items-center ml-4 bg-[#32345a]"
              >
                <svg
            ...
            <div class="flex">
              <div v-if="v_banner == 1" class="w-[850px] mx-[25px]">
                <div class="relative">
                  ...
                  >
                    <img
                      class="h-[240px] w-[300px] mx-[50px] rounded-lg"
              ...
              <div class="flex-column">
                ...
                <div class="flex items-center justify-start mt-5">
                  <div class="relative z-0 mr-10">
                    <input
                      type="number"
                      id="ubicacion_componente_banner"
                      name="ubicacion_componente"
                      :readonly="read_only"
                      v-model="form_componente.ubicacion_componente"
                      class="block py-2.5 px-0 w-48 text-sm text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 peer focus:border-lightPurpleLogin peer"
                    ...
                    <div class="flex justify-start mt-2">
                      ...
                      >
                        <input
                          ...
                          class="sr-only peer"
                          :disabled="read_only"
                          id="visibilidad_componente_banner"
                          name="visibilidad_componente"
                          v-model="form_componente.visibilidad_componente"
                        />
                        <div
            ...
            <div class="flex justify-between w-full">
              ...
              <div class="flex-col mt-[7%] w-72">
                <div class="relative z-0">
                  <input
                    type="text"
                    id="titulo_lamina_banner"
                    name="titulo_lamina_banner"
                    required
                    maxlength="100"
                    v-model="form_banner.titulo_lamina"
                    @input="cambiosGuardados"
                    :readonly="read_only_laminas"
                    class="block py-2.5 px-0 w-full text-sm text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 peer focus:border-lightPurpleLogin peer"
                    placeholder=" "
                ...
                <div class="relative z-0 mt-8">
                  <textarea
                    id="cotenido_lamina_banner"
                    name="contenido_lamina_banner"
                    required
                    :readonly="read_only_laminas"
                    v-model="form_banner.contenido_lamina"
                    @input="cambiosGuardados"
                    maxlength="1000"
                    class="block h-12 max-h-64 py-2.5 px-0 w-full text-sm text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 peer focus:border-lightPurpleLogin peer"
                    placeholder=" "
              ...
              <div class="flex-col ml-14">
                ...
                <div
                  class="h-52 w-48 border-2 border-slate-900 rounded-lg cursor-pointer relative max-[630px]:m-auto"
                  @click="SELECCIONAR_ARCHIVO2"
                  @mouseover="iconoBorrarTrue2"
                  @mouseleave="iconoBorrarFalse2"
                >
                  <img
                    v-if="imagen_preview2"
                    :src="imagen_preview2"
                    class="w-48 rounded-lg h-52"
                  />
                  <input
                    ...
                    ref="input_imagen2"
                    class="hidden"
                    @change="cambiarImagen2"
                  />
                  <div
                    v-if="mostrar_icono_borrar2"
                    class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 rounded-lg"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
...
function seleccionarTipoComponente(tipo) {
  ...
  tipo_seleccionado.value = tipos_componentes_filtrados.value.filter(
    (item) => item.id_tipo_componente == tipo
  );
  informacion_componente_seleccionado.value.nombre =
    tipo_seleccionado.value[0].tipo_componente;
  informacion_componente_seleccionado.value.descripcion =
    tipo_seleccionado.value[0].descripcion_tipo_componente;
  informacion_componente_seleccionado.value.preview =
    tipo_seleccionado.value[0].imagen_tipo_componente;
}
...
async function abrirModal() {
  if (informacion_componente_seleccionado.value.nombre == "Slider") {
    ...
    informacion_componente_seleccionado.value.nombre == "Imagen - Texto V1" ||
    informacion_componente_seleccionado.value.nombre == "Imagen - Texto V2"
  ) {
    if (informacion_componente_seleccionado.value.nombre == "Imagen - Texto V1") {
      v_banner.value = 1;
    } else {
      v_banner.value = 2;
    }
...
async function empezarAEditar() {
  if (id_componente.value) {
    ...
    Swal.fire({
      title: "Confirmación",
      text:
        "Una vez seleccionado este tipo de componente, podrá editar la información de su contenido, pero no podrá cambiar su tipo de componente. ¿Desea continuar?",
      icon: "info",
      reverseButtons: true,
      ...
      if (result.isConfirmed) {
        ...
        FORM_DATA.append(
          ...
          form_componente.value.visibilidad_componente ? 1 : 0
        );
    ...
    if (informacion_componente_seleccionado.value.nombre == "Slider") {
      if (!laminas_slider.value && pagina.value > 2) {
        ...
        form_laminas_slider.value.archivo_imagen =
          laminas_slider.value[pagina.value - 2].campos.archivo_imagen;
        imagen_preview.value =
          RUTA_IMAGENES_LAMINAS + form_laminas_slider.value.archivo_imagen;
        form_laminas_slider.value.titulo_lamina =
          laminas_slider.value[pagina.value - 2].campos.titulo_lamina;
        form_laminas_slider.value.subtitulo_lamina =
          laminas_slider.value[pagina.value - 2].campos.subtitulo_lamina;
        form_laminas_slider.value.identificador_lamina =
          laminas_slider.value[pagina.value - 2].campos.identificador_lamina;
        form_laminas_slider.value.visibilidad_lamina =
          laminas_slider.value[pagina.value - 2].campos.visibilidad_lamina;
      }
    } else if (informacion_componente_seleccionado.value.nombre == "Acordeón") {
      if (!laminas_acordeon.value && pagina.value > 2) {
          ...
          if (VISIBILIDAD_LAMINA == true) {
            ...
            ITEMS_ACORDEON.push({
              ...
              triggerEl: document.querySelector(
                "#accordion-preview-heading-" + IDENTIFICADOR_LAMINA
              ),
              targetEl: document.querySelector(
                "#accordion-preview-body-" + IDENTIFICADOR_LAMINA
              ),
              active: false,
            });
          }
        ...
        const ACORDEON_OPTIONS = {
          alwaysOpen: false,
          activeClasses:
            "border border-b-0 border-white rounded-t-xl bg-lightPurpleLogin",
        };
        ...
        form_laminas_acordeon.value.titulo_lamina =
          laminas_acordeon.value[pagina.value - 2].campos.titulo_lamina;
        form_laminas_acordeon.value.contenido_lamina =
          laminas_acordeon.value[pagina.value - 2].campos.contenido_lamina;
        form_laminas_acordeon.value.identificador_lamina =
          laminas_acordeon.value[pagina.value - 2].campos.identificador_lamina;
        form_laminas_acordeon.value.visibilidad_lamina =
          laminas_acordeon.value[pagina.value - 2].campos.visibilidad_lamina;
      }
    } else if (
      informacion_componente_seleccionado.value.nombre == "Imagen - Texto V1" ||
      informacion_componente_seleccionado.value.nombre == "Imagen - Texto V2"
  ...
  if (read_only_laminas.value == false) {
    ...
    try {
      if (informacion_componente_seleccionado.value.nombre == "Slider") {
        ...
        FORM_DATA.append(
          "visibilidad_lamina",
          form_laminas_slider.value.visibilidad_lamina ? 1 : 0
        );
        ...
        FORM_DATA.append(
          "visibilidad_lamina",
          form_laminas_acordeon.value.visibilidad_lamina ? 1 : 0
        );
        FORM_DATA.append("id_componente", id_componente.value);
        ...
        preview_banner.value.titulo = res.data.data.lamina.titulo_lamina;
        preview_banner.value.contenido = res.data.data.lamina.contenido_lamina;
        preview_banner.value.imagen =
          RUTA_IMAGENES_LAMINAS + res.data.data.lamina.archivo_imagen;
...
const cambiarImagen2 = () => {
  const INPUT = input_imagen2.value;
  const ARCHIVO = INPUT.files;
  if (ARCHIVO && ARCHIVO[0]) {
...
function limpiarImagen2() {
  ...
  if (input_imagen2.value.value) {
    input_imagen2.value.value = "";
  }
