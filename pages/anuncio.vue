                ...
                <div
                    ...
                    <div class="flex justify-start w-3/4 items-center max-[400px]:w-full">
                        ...
                        <div
                            ...
                            <p class="font-extrabold text-xl text-salte-900 max-[750px]:text-[18px]">Reunion - Eventos</p>
                            <p class="font-normal text-sm mt-1text-gray-500 max-[750px]:text-[12px]">https://ricaldone.edu.sv</p>
                            <p class="font-normal text-sm text-gray-500 max-[750px]:text-[12px]">2023-12-12
                            </p>
                        </div>
                    </div>
                    <div
                    ...
                    <form action="" class="flex justify-evenly">
                        <div class="flex-col w-64">
                            ...
                            <div class="relative z-0 mt-10">
                                <input type="text" id="username" name="description"
                                    class="block py-2.5 px-0 w-full text-sm text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 peer focus:border-moradoClaroLogin peer"
                                    placeholder=" " autocomplete="off" />
                                <label for="username"
