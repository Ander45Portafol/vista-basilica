<template>
    <div class="principal mt-6">
        ...
        <div class="mdprincipal flex-col mt-8 px-8 overflow-hidden">
            ...
            <p class="font-extrabold text-slate-900 mt-8 ml-4">{{ anuncios.length }}<span class="text-gray-500 font-normal ml-2">registros
                    encontrados!</span></p>
                ...
                <div class="data-contained flex justify-between mt-4 rounded-xl p-4">
                    <div class="flex justify-start w-3/4 items-center">
                        ...
                        <div class="datainfo flex-col ml-8">
                            <p class="font-extrabold text-xl text-salte-900">{{ anuncio.titulo_anuncio }}</p>
                            <p class="font-normal text-sm mt-1text-gray-500">{{ anuncio.enlace_externo }}</p>
                            <p class="font-normal text-sm text-gray-500">{{ anuncio.fecha_anuncio }}</p>
                        </div>
                    </div>
                    <div class="buttons-data flex justify-center items-center">
                        <button class="h-10 w-10 rounded-md flex items-center justify-center editbtn" @click="editModal()">
