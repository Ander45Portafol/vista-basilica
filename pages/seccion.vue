                ...
                <div
                    ...
                    <div class="flex justify-start w-3/4 items-center max-[400px]:w-full">
                        ...
                        <div
                            ...
                            <p class="font-extrabold text-xl text-salte-900 max-[750px]:text-[18px]">Carrusel - Parroquias</p>
                            <p class="font-normal text-sm mt-1text-gray-500 max-[750px]:text-[12px]">La familia de hoy</p>
                            <p class="font-normal text-sm text-gray-500 max-[750px]:text-[12px]">Muestra las parroquias afiliadas
                            </p>
                        </div>
                    </div>
                    <div
