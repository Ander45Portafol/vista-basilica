<template>
  ...
  <div v-if="cambio_contra && !enviando_login && !doble_factor"
    ...
    <div
      ...
      <div class="min-[1201px]:w-1/4 max-[1200px]:w-1/2 max-[700px]:w-full max-[700px]:mb-24">
        ...
        <div v-if="mostrar_error_contra" class="mt-10 mx-12 flex items-center justify-center p-4 mb-4 text-sm text-red-300 border border-red-300 rounded-lg"
          role="alert">
