            ...
            <div class="contained-data flex-col">
                <div class="data-contained flex justify-between mt-4 rounded-xl p-4">
                    <div class="flex justify-start w-3/4 items-center">
                        ...
                        <div class="datainfo flex-col ml-8">
                            <p class="font-extrabold text-xl text-salte-900">Guillermo Alejandro Castillo Campos</p>
                            <p class="font-normal text-sm text-black mt-1">guillermogacc0526@gmail.com</p>
                            <p class="font-normal text-sm mt-1 text-gray-500">+503 7633-5320</p>
                        </div>
                    </div>
                ...
                <div class="data-contained flex justify-between mt-4 rounded-xl p-4">
                    <div class="flex justify-start w-3/4 items-center">
                        <img src="" class="h-10 w-10 rounded-lg border-2 border-gray-800" />
                        <div class="datainfo flex-col ml-8">
                            <p class="font-extrabold text-xl text-salte-900">Anderson Aguilar Ramos</p>
                            <p class="font-normal text-sm text-black mt-1">guillermogacc0526@gmail.com</p>
                            <p class="font-normal text-sm mt-1 text-gray-500">+503 7633-5320</p>
                        </div>
                    </div>
