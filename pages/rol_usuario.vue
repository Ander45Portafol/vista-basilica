        ...
        <div class="mdprincipal flex-col mt-8 px-8 overflow-hidden">
            ...
            <div class="h-screen">
                ...
                <div class="tables overflow-y-scroll h-3/5 pr-4">
                    <TablesRolUsuario :datosRol="rolusuarios" :actualizarDatos="leerRolesUsuarios" />
                </div>
        ...
        <div class="relative w-full max-w-md max-h-full">
            ...
            <div class="relative rounded-lg shadow modal">
                ...
                <div class="p-6 space-y-6 pb-10">
                    <form @submit.prevent="submitForm()" class="mt-4 flex justify-center pb-4">
                        <div class="flex-col w-64">
                            <input type="hidden" v-model="form.id_rol_usuario">
                            <div class="relative z-0">
                                <input type="text" id="rol_usuario" name="rol_usuario" required maxlength="50"
                                    @input="validarRolUsuario()"
                                    class="block py-2.5 px-0 w-full text-sm text-gray-200 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 peer focus:border-moradoClaroLogin peer"
                                    placeholder=" " autocomplete="off" v-model="form.rol_usuario" />
                                <span class="text-xs text-gray-400 absolute bottom-0.5 right-0" v-if="form.rol_usuario">
                                    {{
                            ...
                            <div v-if="!validarRolUsuario()" class="flex mt-2 mb-0 text-sm text-red-400 bg-transparent"
                                ...
                                <div>
                                    El rol de usuario solo permite caracteres <span class="font-medium">
                                        alfanuméricos y algunos especiales (- / |).</span>
                                </div>
                            </div>
                            <div class="flex-col mt-10">
                                <label for="" class="text-sm text-gray-200">Visibilidad - Rol usuario</label>
                            ...
                            <div class="modal-buttons mt-10 flex justify-end items-end">
                                ...
                                <button class="h-10 w-10 rounded-lg flex justify-center items-center" type="submit"
                                    :disabled="!validarRolUsuario()" id="btnModalAdd">
