<template>
    ...
    <MenuMisaDashboard class="mr-8" />
        ...
        <div class="mdprincipal flex-col mt-8 px-8 overflow-hidden">
            ...
            <div class="h-screen">
                <p v-if="misas" class="font-extrabold text-slate-900 mt-8 ml-4 max-[425px]:mt-16">{{ misas.length
                ...
                <div class="tables overflow-y-scroll h-3/5 pr-4">
                    <div v-if="!misas" class="loadingtable overflow-hidden h-full pr-4">
                    ...
                    <TablesMisa v-if="misas" :datosMisas="misas" :actualizarDatos="leerMisas" />
                </div>
                <div class="flex justify-center mt-6">
                    <TailwindPagination v-if="misas"
