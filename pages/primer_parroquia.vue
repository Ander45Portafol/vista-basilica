    ...
    <div class="flex ml-16 h-full w-full">
        <div class="w-3/4 flex-col mt-20">
            ...
            <form class="flex mr-8 mt-20 justify-between items-center">
                ...
                <div class="flex-col">
                    <div class="">
                        <p class="mb-4 text-center text-gray-200">Logo - Parroquia</p>
                        <div class="flex-col m-auto">
                            <div
                                ...
                                <img src="" alt="logo" class="h-44 w-40 rounded-lg" />
                                <input type="file" ref="inputImagen" class="hidden" />
                                <div class="m-auto max-[630px]:text-center max-[630px]:ml-[-58px]">
                                    <button type="button"
                                        class="w-40 py-2 mt-3 bg-white rounded-md hover:bg-slate-300 text-center">Seleccionar
                                        Imagen</button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="flex justify-start items-end h-56">
                <div class="flex-col">
                    ...
                    <p class="font-extralight text-base text-gray-400 mt-4">Una vez ingresada la información, solo podrás cambiarla
