        ...
        <div
          ...
          <div
            ...
            <button class="h-10 w-10 rounded-md flex items-center justify-center max-[400px]:mx-4 editbtn" id="btnedit"
              @click="leerUnaPagina(pagina.id_pagina)" v-if="pagina.visibilidad_pagina == 1">
            ...
            <div class="flex-col w-72">
              ...
              <div class="relative z-0 mt-6">
                ...
                <input type="text" id="nombre_pagina" name="nombre_pagina" v-model="form.nombre_pagina"
                  ...
                  placeholder=" " autocomplete="off" /><span class="text-xs text-gray-400 absolute bottom-0.5 right-0">
                ...
                <div v-if="!validarNombrePagina()" class="flex mt-2 mb-0 text-sm text-red-400 bg-transparent"
                  role="alert">
              ...
              <div class="relative z-0 mt-6">
                ...
                <label for="numero_pagina"
                  ...
                  - Página <span class="text-sm ml-1"> * </span></label>
                <!-- Se coloca un if que evalua si la función de validar es false, así se muestra la alerta solo cuando es false -->
                <div v-if="!validarNumeroPagina()" class="flex mt-2 mb-0 text-sm text-red-400 bg-transparent"
                  role="alert">
                  <svg aria-hidden="true" class="flex-shrink-0 inline w-5 h-5 mr-3" fill="currentColor"
                    viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
              ...
              <div class="flex-col mt-6">
                ...
                <div class="flex justify-start mt-2">
                  <label class="relative inline-flex items-center mb-5 cursor-pointer">
                    <input type="checkbox" value="" class="sr-only peer" id="visibilidad_pagina" name="visibilidad_pagina"
                ...
                <div class="modal-buttons mt-4 flex justify-end items-end">
                  ...
                  <button id="btnModalAdd" type="submit" :disabled="!validarNumeroPagina() || !validarNombrePagina()"
                  ...
                  <button id="btnModalUpdate" type="submit" :disabled="!validarNumeroPagina() || !validarNombrePagina()"
                    class="h-10 ml-2 w-10 rounded-lg flex justify-center items-center">
                    <svg width="22px" height="22px" stroke-width="2" viewBox="0 0 24 24" fill="none"
                      xmlns="http://www.w3.org/2000/svg" color="#000000">
                      <path
