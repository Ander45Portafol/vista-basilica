...
<template>
    <div class="principal flex justify-between">
        ...
        <div class="endtop flex justify-between w-20">
            ...
            <button type="button" @click="openDrawer()" data-drawer-target="drawer-right-example" data-drawer-show="drawer-right-example"
