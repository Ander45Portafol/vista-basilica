        ...
        <div class="flex h-screen w-full ml-36 items-center">
            <div class=" h-96 w-1/6 mb-24 bg-space opacity-95 mt-40 rounded-lg p-4 text-white flex-col">
                ...
                <div class="text-white mt-4 text-center">
                    <p class="text-2xl font-bold">Juan Bosco</p>
                    <p>administrador</p>
            ...
            <div class=" h-4/6 w-3/5 mb-12  bg-space opacity-95 mt-40 ml-12 rounded-lg p-6 text-white flex-col">
                ...
                <form class="flex justify-evenly mt-14">
                    ...
                    <div class="flex-col w-72">
                        ...
                        <div class="flex items-end  h-44 justify-end w-96">
                            <button class="bg-darkSpace w-52 flex items-center h-12 rounded-xl gap-4 justify-center">
                                <svg width="24px" height="24px" stroke-width="2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#000000"><path d="M7 12.5l3 3 7-7" stroke="#FFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z" stroke="#FFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg> Actualizar
                            </button>
                        </div>
                    </div>
                </form>
