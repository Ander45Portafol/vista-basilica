                ...
                <div
                    ...
                    <div class="flex justify-start w-3/4 items-center max-[400px]:w-full">
                        ...
                        <div
                            ...
                            <p class="font-extrabold text-xl text-salte-900 max-[750px]:text-[18px]">Mantenimiento General</p>
                            <p class="font-normal text-sm mt-1text-gray-500 max-[750px]:text-[12px]">
                                <span>$</span>10k</p>
                            <p class="font-normal text-sm text-gray-500 max-[750px]:text-[12px]">Abierto
                            </p>
                        </div>
                    </div>
                    <div
