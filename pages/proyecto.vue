                ...
                <div class="data-contained flex justify-between mt-4 rounded-xl p-4">
                    <div class="flex justify-start w-3/4 items-center">
                        ...
                        <div class="datainfo flex-col ml-8">
                            <p class="font-extrabold text-xl text-salte-900">Mantenimiento general</p>
                            <p class="font-normal text-sm mt-1text-gray-500">$10,000</p>
                            <p class="font-normal text-sm text-gray-500">Abierto</p>
                        </div>
                    </div>
